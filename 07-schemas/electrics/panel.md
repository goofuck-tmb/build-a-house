...
6. **Щит куплен:** ЩРН IP66, металл, 48 мод. (4×12), глубина 155 мм, съёмная рама, замок. Аппаратов набирается ~35–38 → запас ~10 модулей: обогрев и вольтметр планировать с учётом этого. Металл → **заземлить корпус** (PE на корпус) и заложить **обогрев** от конденсата.
...
| Оборудование | Кол-во |
|--------------|:------:|
| ✅ Щит ЩРН IP66, металл, **48 мод. (4×12)**, 700×300×155, съёмная рама, замок — **куплен (8600 ₽)** | 1 |
