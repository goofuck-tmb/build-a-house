...
|---------|---------|------|
| Ввод 3ф | **ABB S204, 4P, C25** | Главный автомат, отключение всего щита (25 А = 15 кВт) |
...
```mermaid
flowchart TD
  OP["Опора сетевой<br/>счётчик 3ф + GSM"] -->|"СИП-4 4x16 (воздушка)"| VV["Ввод 3ф<br/>ABB S204 4P C25"]
